...
ТРЕБОВАНИЯ:
- Каждый слайд должен содержать ПОЛНЫЙ учебный материал (минимум 3 абзаца по 2-4 предложения)
- Если уместно, добавляй маркированные списки с пояснениями, а не короткие тезисы
- Для технических тем обязательно добавляй примеры кода в code_example (минимум 2 слайда с кодом)
- Добавь learning_objectives (3-4 цели) и key_takeaways (3-4 вывода)
- Не сокращай объяснения: материал должен быть рассчитан на заявленную длительность урока
