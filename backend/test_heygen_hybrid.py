"""
Гибридный тест HeyGen API - правильные endpoints + обход SSL
"""
...
def test_heygen_hybrid():
    """Тестирует HeyGen API с правильными endpoints и обходом SSL"""
    ...
    print("Testing HeyGen API with correct endpoints + SSL bypass...")
    print("=" * 60)
    ...
    try:
        response = requests.get(
            ...
            headers=headers,
            timeout=10,
            verify=False  # Обходим SSL для корпоративной сети
        )
...
def main():
    ...
    print("HEYGEN API HYBRID TEST (Correct endpoints + SSL bypass)")
    print("=" * 60)
    
    # Test with correct endpoints and SSL bypass
    auth_ok = test_heygen_hybrid()
    ...
    if auth_ok:
        ...
        print("3. Keep verify=False for corporate network")
